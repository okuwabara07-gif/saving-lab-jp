...
const SITE_NAME = '節約LAB';
const TOPIC = '節約・家計管理・格安サービス';
const CRITERIA = '節約効果・使いやすさ・コスパ・継続しやすさ・口コミ';
const A8_PRODUCT_NAME = 'DMM FX';
const A8_PRODUCT_URL = 'https://px.a8.net/svt/ejp?a8mat=4AZR8U+DHKB6E+1WP2+ZQNG3';
const A8_PRODUCT_DESC = '初心者でも安心のFX取引';
